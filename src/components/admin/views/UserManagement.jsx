            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-[#2278B0] focus:border-indigo-500 outline-none w-full sm:w-64"
                        value={searchTerm}
                                    ...
                                    <tr key={user.id} className="hover:bg-slate-50 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-full bg-indigo-100 flex items-center justify-center font-bold text-[#2278B0]">
                    ...
                    {users.length > 0 && (
                        <div className="p-4 border-t border-slate-100 text-center">
                            <button
                                ...
                                disabled={loading}
                                className="text-[#2278B0] font-medium hover:text-[#124263] disabled:opacity-50 text-sm"
                            >
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-9 h-9 rounded-full bg-emerald-100 flex items-center justify-center font-bold text-emerald-700">
                                                    {(inst.institutionProfile?.name || inst.name || inst.email || '?')[0].toUpperCase()}
                                                </div>
                                                <div>
                                                    <div className="font-medium text-slate-900">{inst.institutionProfile?.name || inst.name || 'Unnamed'}</div>
                                                    <div className="text-xs text-slate-400">
                                                        {inst.username ? `@${inst.username}` : inst.email}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                                ...
                                                {editingLimit?.id === inst.id ? (
                                                    <>
                                                        <input
                                                            ...
                                                            className="w-20 px-2 py-1 border border-indigo-300 rounded-lg text-center text-sm font-bold focus:outline-none focus:ring-2 focus:ring-[#2278B0]/30"
                                                            autoFocus
                                                        />
                                                        <button
                                                    ...
                                                    <>
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-1.5 text-slate-400 hover:text-[#2278B0] hover:bg-indigo-50 rounded-lg transition-colors"
                                                            title="Edit limit"
                                                        >
                                                            <Edit2 size={14} />
                                                        </button>
