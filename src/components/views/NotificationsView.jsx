...
import { Bell, Trash2, CheckCircle, Building2, UserCheck, FileText as FileTextIcon, ChevronLeft } from 'lucide-react';
    ...
    return (
        <div>
            <button
                ...
                className="ml-4 p-2 border border-slate-200 bg-white shadow-sm text-slate-500 rounded-xl hover:bg-slate-50 hover:text-slate-800 transition-colors mt-1 active:scale-95"
